...
CREATE TABLE `Disabilities` (
  `Disabilitie_ID` int NOT NULL,
  `Disability_description` varchar(45) NOT NULL,
  PRIMARY KEY (`Disabilitie_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf16;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Employees` (
  ...
  CONSTRAINT `fk_Employees_Disabilities` FOREIGN KEY (`Disability_ID`) REFERENCES `Disabilities` (`Disabilitie_ID`),
...
--
-- Table structure for table `Employees_Ethinicity`
--

DROP TABLE IF EXISTS `Employees_Ethinicity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Employees_Ethinicity` (
  `Employee_ID` int NOT NULL,
  `Ethinicity_ID` int NOT NULL,
  PRIMARY KEY (`Employee_ID`,`Ethinicity_ID`),
  KEY `fk_Employees_has_Ethinicity_Ethinicity1_idx` (`Ethinicity_ID`),
  KEY `fk_Employees_has_Ethinicity_Employees1_idx` (`Employee_ID`),
  CONSTRAINT `fk_Employees_has_Ethinicity_Employees1` FOREIGN KEY (`Employee_ID`) REFERENCES `Employees` (`Employee_ID`),
  CONSTRAINT `fk_Employees_has_Ethinicity_Ethinicity1` FOREIGN KEY (`Ethinicity_ID`) REFERENCES `Ethinicity` (`Ethinicity_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf16;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Employees_Ethinicity`
--

LOCK TABLES `Employees_Ethinicity` WRITE;
/*!40000 ALTER TABLE `Employees_Ethinicity` DISABLE KEYS */;
INSERT INTO `Employees_Ethinicity` VALUES (2,1),(5,1),(35,1),(42,1),(43,1),(47,1),(54,1),(55,1),(56,1),(65,1),(70,1),(81,1),(88,1),(91,1),(98,1),(105,1),(118,1),(120,1),(124,1),(129,1),(130,1),(143,1),(150,1),(163,1),(165,1),(166,1),(169,1),(171,1),(183,1),(184,1),(185,1),(196,1),(199,1),(6,2),(9,2),(10,2),(13,2),(14,2),(25,2),(48,2),(49,2),(57,2),(63,2),(106,2),(107,2),(117,2),(132,2),(140,2),(144,2),(145,2),(152,2),(154,2),(155,2),(166,2),(191,2),(18,3),(23,3),(60,3),(68,3),(70,3),(75,3),(77,3),(81,3),(82,3),(88,3),(91,3),(114,3),(127,3),(132,3),(138,3),(162,3),(167,3),(176,3),(192,3),(197,3),(7,4),(9,4),(12,4),(14,4),(16,4),(35,4),(43,4),(63,4),(80,4),(98,4),(100,4),(103,4),(123,4),(128,4),(134,4),(144,4),(154,4),(155,4),(163,4),(185,4),(188,4),(191,4),(200,4),(37,5),(69,6),(94,6),(99,6),(113,6),(1,7),(2,7),(3,7),(4,7),(7,7),(8,7),(11,7),(15,7),(17,7),(18,7),(19,7),(20,7),(21,7),(22,7),(23,7),(24,7),(26,7),(27,7),(28,7),(29,7),(30,7),(31,7),(32,7),(33,7),(34,7),(36,7),(38,7),(39,7),(40,7),(41,7),(44,7),(45,7),(46,7),(50,7),(51,7),(52,7),(53,7),(58,7),(59,7),(60,7),(61,7),(62,7),(64,7),(66,7),(67,7),(68,7),(71,7),(72,7),(73,7),(74,7),(75,7),(76,7),(77,7),(78,7),(79,7),(80,7),(82,7),(83,7),(84,7),(85,7),(86,7),(87,7),(89,7),(90,7),(92,7),(93,7),(95,7),(96,7),(97,7),(100,7),(101,7),(102,7),(103,7),(104,7),(108,7),(109,7),(110,7),(111,7),(112,7),(114,7),(115,7),(116,7),(118,7),(119,7),(120,7),(121,7),(122,7),(123,7),(124,7),(125,7),(126,7),(127,7),(128,7),(129,7),(131,7),(133,7),(134,7),(135,7),(136,7),(137,7),(138,7),(139,7),(141,7),(142,7),(146,7),(147,7),(148,7),(149,7),(151,7),(153,7),(156,7),(157,7),(158,7),(159,7),(160,7),(161,7),(162,7),(163,7),(164,7),(167,7),(168,7),(169,7),(170,7),(171,7),(172,7),(173,7),(174,7),(175,7),(176,7),(177,7),(178,7),(179,7),(180,7),(181,7),(182,7),(186,7),(187,7),(188,7),(189,7),(190,7),(192,7),(193,7),(194,7),(195,7),(197,7),(198,7),(199,7),(200,7);
/*!40000 ALTER TABLE `Employees_Ethinicity` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Ethinicity` (
  `Ethinicity_ID` int NOT NULL,
  `Ethinicity_description` varchar(45) NOT NULL,
  PRIMARY KEY (`Ethinicity_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf16;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `Ethinicity` WRITE;
/*!40000 ALTER TABLE `Ethinicity` DISABLE KEYS */;
INSERT INTO `Ethinicity` VALUES (1,'Asian'),(2,'Black'),(3,'Latin'),(4,'Middle Eastern'),(5,'Other'),(6,'Prefer not to say'),(7,'White');
/*!40000 ALTER TABLE `Ethinicity` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-06  4:30:31
